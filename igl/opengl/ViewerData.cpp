	...
	const Eigen::MatrixXd& _V, const Eigen::MatrixXi& _F)
{
	...
	if (V.rows() == 0 && F.rows() == 0)
	{
		...
		image_texture("C:/Users/97254/Documents/Animation/EngineForAnimationCourse/tutorial/textures/snake.jpg");
		//    grid_texture();
	}
	else
	{
...
// Helpers that draws the most common meshes
IGL_INLINE void igl::opengl::ViewerData::set_mesh(
	const Eigen::MatrixXd& _V, const Eigen::MatrixXi& _F, bool mouse)
{
	using namespace std;
	...
	if (V.rows() == 0 && F.rows() == 0)
	{
		...
		compute_normals();
		uniform_colors(
			Eigen::Vector3d(WHITE[0], WHITE[1], WHITE[2]),
			Eigen::Vector3d(WHITE[0], WHITE[1], WHITE[2]),
			Eigen::Vector3d(WHITE[0], WHITE[1], WHITE[2]));
		if (mouse)
			image_texture("C:/Users/97254/Documents/Animation/EngineForAnimationCourse/tutorial/textures/mouse.jfif");
		else
			image_texture("C:/Users/97254/Documents/Animation/EngineForAnimationCourse/tutorial/textures/fur.jfif");
