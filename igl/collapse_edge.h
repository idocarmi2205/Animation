...
namespace igl
{
  ...
  IGL_INLINE bool collapse_edge_by_algo(
      Eigen::MatrixXd& V,
      Eigen::MatrixXi& F,
      Eigen::MatrixXi& E,
      Eigen::VectorXi& EMAP,
  ...
  double computeCost(int vFirst, int vSecond, Eigen::MatrixXd& V, std::vector<Eigen::Matrix4d*>& VC, igl::min_heap< std::tuple<double, int, int> >& Q,
